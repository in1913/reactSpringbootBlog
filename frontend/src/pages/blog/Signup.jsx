                    ...
                    <Col lg={8} md={6} sm={12} className='mt-1 ps-4 pe-4'>
                        <MyInfo>
                            ...
                            <Row style={{height: "45px"}}>
                                ...
                                <Col xs={8}>
                                    <MyInput type='text' onChange={(e) => setMemname(e.target.value)}  placeholder='이름' spellCheck="false"/>
                                </Col>
                            ...
                            <Row style={{height: "45px"}}>
                                ...
                                <Col xs={8}>
                                    <MyInput type='text' onChange={(e) => setNickname(e.target.value)}  placeholder='닉네임' spellCheck="false"/>
                                </Col>
                            ...
                            <Row style={{height: "45px"}}>
                                ...
                                <Col xs={8}>
                                    <MyInput type='email' onChange={(e) => setMememail(e.target.value)} placeholder='example@example.com' spellCheck="false"/>
                                </Col>
                            ...
                            <Row style={{height: "45px"}}>
                                ...
                                <Col xs={8}>
                                    <MyInput type='password' onChange={(e) => setMempass(e.target.value)}  spellCheck="false"/>
                                </Col>
                            ...
                            <Row style={{height: "45px"}}>
                                ...
                                <Col xs={8}>
                                   <MyInput  type='text' onChange={(e) => setAddress(e.target.value)}  placeholder='주소' spellCheck="false"/>
                            ...
                            <Row style={{height: "45px"}}>
                                ...
                                <Col xs={8}>
                                    <MyInput type='text' onChange={(e) => setTel(e.target.value)} placeholder='숫자만 입력' spellCheck="false"/>
